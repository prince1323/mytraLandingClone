...
men_section.onmouseover = () => {
    //here we used classList.remove method to remove visibility class from mens_section_items
    men_section_items.classList.remove('visibility');
}
men_section.onmouseout = () => {
    //here we used classList.add method to add visibility class from mens_section_items
